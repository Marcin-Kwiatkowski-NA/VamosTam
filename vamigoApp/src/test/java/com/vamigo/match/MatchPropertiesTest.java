...
class MatchPropertiesTest {
    ...
    void topLevelAccessorsReturnPerFeatureStrategy() {
        MatchProperties props = new MatchProperties(
                new MatchProperties.FeatureRadius(null, 3.0, 30.0, null),   // rideSmart
                new MatchProperties.FeatureRadius(null, 4.0, 20.0, null),   // seatSmart
                new MatchProperties.FeatureRadius(50.0, null, null, null),  // alert
                new MatchProperties.FeatureRadius(75.0, null, null, null)   // externalImport
        );
